...
$brg->edit("UPDATE tb_brg SET nm_brg='$nama_barang', hrg_jwl='$hrg_jual', hrg_bli='$hrg_beli', stk='$stok', expr='$expr', status='1' WHERE kd_brg='$kd_brg'");
echo "<script>window.location='?page=dtbarang';</script>";										
?>