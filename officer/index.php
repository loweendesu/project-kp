...
<body class="sticky-header left-side-collapsed" onload="initMap()">
	<section>
					...
					<li class="menu-list">
						<a href="#"><i class="lnr lnr-cart"></i>
							...
							<ul class="sub-menu-list">
								<li><a href="?page=utrbrgmsk">Pemasukan Barang</a> </li>
								<li><a href="?page=transmskan">Trans. Barang Masuk</a> </li>
								<li><a href="?page=udttransmsk">Detail Transaksi Masuk</a> </li>
							</ul>
						</li>
						<li class="menu-list">
							<a href="#"><i class="lnr lnr-upload"></i>
								...
								<ul class="sub-menu-list">
									...
									<li><a href="?page=udtilpnglran">Detail Pengeluaranr</a> </li>
								</ul>
							</li>             
							<li class="menu-list"><a href="#"><i class="lnr lnr-book"></i> <span>Barang</span></a>
								<ul class="sub-menu-list">
									<li><a href="?page=ubarang">Barang</a> </li>
									<li><a href="?page=udtbarang">Detail Barang</a></li>
								</ul>
							</li>  
											...
											<li class="dropdown">
												<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
													...
													<ul class="dropdown-menu">
														...
														<li>
															<div class="notification_bottom">
																<a href="?page=udtputng">Buka Data Pitutang</a>
															</div> 
														</li>
													</ul>
												</li>		   	
												<li class="dropdown">
													<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
														...
														<ul class="dropdown-menu">
															...
															<li>
																<div class="notification_bottom">
																	<a href="?page=udtbarangstk">Buka Data Barang</a>
																</div> 
															</li>
														</ul>
													</li>		   							   		
												...
												<ul>
													<li class="dropdown profile_details_drop">
														<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
															<div class="profile_img">	
																...
																<div class="user-name">
																	...
																	?>
																	<p><?php echo "~".$row['nm_ptgs']?><span>Petugas</span></p>
																</div>
														...
														<ul class="dropdown-menu drp-mnu">
															...
															<li> <a href="?page=uprofile"><i class="fa fa-user"></i>Profil</a> </li> 
		...
		<div id="page-wrapper" style="height: 2450px">
			...
			if($cekutngnow > '0'){
				include "../views/utmpilputngnow.php";
			}

			$tampilutng2 = $Mskcek->tampilv2();
			$cekutng2 = mysqli_num_rows($tampilutng2);
			if($cekutng2 > '0'){
				include "../views/utmpilputng.php";
			}

			if(@$_GET['page']=='dashboard' || @$_GET['page']==''){
				include "../views/dashboard.php";
			}else if(@$_GET['page']=='udtbarang'){
				include "../views/udtbarang.php";
			}else if(@$_GET['page']=='ubarang'){
				include "../views/ubarang.php";
			}else if(@$_GET['page']=='uprofile'){
				include "../views/uprofile.php";
			}else if(@$_GET['page']=='utrbrgmsk'){
				include "../views/utrbrgmsk.php";
			}else if(@$_GET['page']=='udttransmsk'){
				include "../views/udttransmsk.php";
			}else if(@$_GET['page']=='dttransklr'){
				include "../views/dttransklr.php";
			}else if(@$_GET['page']=='udtilpnglran'){
				include "../views/udtilpnglran.php";
			...
			}else if(@$_GET['page']=='udtputng'){
				include "../views/udtputng.php";
			}else if(@$_GET['page']=='dtmngusr'){
				include "../views/dtmngusr.php";
			}else if(@$_GET['page']=='udtbarangstk'){
				include "../views/udtbarangstk.php";
			}
