...
$pdf->Cell(190,6,'Rekap Tanggal '.$dari.' - '.$sampai,0,1);

// Memberikan space kebawah agar tidak terlalu rapat
$pdf->Cell(10,7,'',0,1);
 
$pdf->SetFont('Arial','B',10);
$pdf->Cell(10,6,'No.',100,0,'C');
