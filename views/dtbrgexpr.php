			...
			<form id="edt">
				<div class="modal-body" id="modal-edit">
					<div class="form-group">
						...
						<input type="hidden" name="id_jns" class="form-control" id="id_jns" required>
						<input type="text" name="id_jns2" class="form-control" id="id_jns2" disabled>

						<label class="control-label" for="hrg">Harga:</label>
						<input type="hidden" name="hrg" class="form-control" id="hrg" required>
						<input type="number" name="hrg2" class="form-control" id="hrg2" disabled>
						...
						<input type="hidden" name="kdsupp" class="form-control" id="kdsupp" required>

						<!-- <label class="control-label" for="almtsupp">Alamat Supplier:</label> -->
						<input type="hidden" name="almtsupp" class="form-control" id="almtsupp" required>

						<!-- <label class="control-label" for="tlpsup">No Tlp:</label> -->
						<input type="hidden" name="tlpsup" class="form-control" id="tlpsup" required>
...
<script type="text/javascript">
	$(document).on("click", "#edit_brg2", function(){
							...
							$("#modal-edit2 #kd_brg2").val(kdbrg);
							$("#modal-edit2 #id_jns").val(nama);
							$("#modal-edit2 #id_jns2").val(nama);
							// $("#modal-edit #expr").val(expr);
							$("#modal-edit2 #hrg").val(hrg);
							$("#modal-edit2 #hrg2").val(hrg);
							// $("#modal-edit #satuan").val(satuan);
