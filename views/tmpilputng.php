...
<div class="panel panel-warning" data-widget="{&quot;draggable&quot;: &quot;false&quot;}" data-widget-static="">
							...
							<thead>
								...
								$no = $posisi +1;
								$tampil = $Mskan->tampilv2();
								while($data = $tampil->fetch_object()){

									?> 
									<tr class="warning">
									<td align="center"><?php echo 'Transaksi dengan '.$data->nm_supp.' memasuki Tanggal Jatuh Tempo '.$data->tempo.'. Siapkan dana untuk pelunasan sebesar Rp. '.number_format($data->tottrans); ?></td>
									<td>
										<button type="button" class="btn btn-default btn-xs" data-toggle="modal" data-target="#myModalputang<?=$data->transmsk;?>">Lihat</button>

										<!-- Modal -->
									<div id="myModalputang<?=$data->transmsk;?>" class="modal fade" role="dialog">
				...
				<form action="../models/ubahstatusbyr.php" method="POST">
