	...
	<div class="col-lg-12">
		<div class="panel panel-warning" data-widget="{&quot;draggable&quot;: &quot;false&quot;}" data-widget-static="">
			<div class="panel-heading">
				<h2>Trans. Pengeluaran Barang</h2>
			...
			<div class="panel-body no-padding" style="display: block;">
				<div class="table-responsive">
					<table class="table table-bordered table-hover table-striped">
						...
						$batas=10;
								...
								$no = $posisi +1;
						$tampil = $Transout->tampilv3limit($posisi,$batas);
							...
							<!-- 	<td><?php echo $data->nm_brg; ?></td>
								...
								<td>
									<?php 
										if ($data->ket == "Return") {
										?>
										<form action="../views/ctkntaklr.php" method="POST">
									<input type="hidden" name="nm_supp" value="<?php echo $data->nm_supp; ?>">
									<input type="hidden" name="ket" value="<?php echo $data->ket; ?>">
									<input type="hidden" name="tgl" value="<?php echo $data->tgl; ?>">
									<input type="hidden" name="almtsupp" value="<?php echo $data->almtsupp; ?>">
									<input type="hidden" name="tlpsup" value="<?php echo $data->tlpsup; ?>">
									<input type="submit" class="btn btn-default btn-xs" name="cetak" value="Cetak Nota">
									</form>

									<?php 		
										}elseif ($data->ket == "Masuk Toko") {
											echo "-";
										}
				...
				<?php 
				$baris=$Transout->tampilv3();
				$jml=mysqli_num_rows($baris);
				$jml_hal = ceil($jml/$batas);
				for ($i=1; $i<=$jml_hal ; $i++){
					if($i != $hal){
						echo "<a href='?page=transklran&hal=$i'><button style='background-color:#fff; border:1px solid:#666; color:#666'>$i</button></a>";
					}else{
