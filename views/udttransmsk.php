	...
	<div class="col-lg-12">
		<div class="panel panel-warning" data-widget="{&quot;draggable&quot;: &quot;false&quot;}" data-widget-static="">
					...
					<table class="table table-bordered table-hover table-striped">
						<tr>
							...
							<tbody id="carit">
								...
								$no = $posisi +1;
								$tampil = $Transin->tampillimitv2($posisi,$batas);
								...
								<!-- <td><?php echo $data->transbrg_msk; ?></td>
									...
									<td><?php echo $data->jmlh; ?> <?php echo $data->satuan; ?></td>
			...
			<div class="pagination">
				...
				for ($i=1; $i<=$jml_hal ; $i++){
					if($i != $hal){
						echo "<a href='?page=udttransmsk&hal=$i'><button style='background-color:#fff; border:1px solid:#666; color:#666'>$i</button></a>";
					}else{
			...
			<!-- <div class="panel-heading">
				<h2>Cetak Rekap Persediaan Barang</h2>
				<div class="panel-ctrls" data-actions-container="" data-action-collapse="{&quot;target&quot;: &quot;.panel-body&quot;}"><span class="button-icon has-bg"><i class="ti ti-angle-down"></i></span></div>
			</div>
			<form action="../views/ctktransmsk.php" method="POST">
				<div class="col-md-6 col-centered">
					<h4><label class="panel-warning" for="print">Dari Tanggal</label></h4><input type="date" name="dari" class="form-control" id="dari" required>
				</div>
				<div class="col-md-6 col-centered">
